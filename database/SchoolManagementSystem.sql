...
create table Student (
	...
	LastName varchar(50),
	StudentPhoto varchar(1000),
	Email varchar(50),
	PhoneNumber varchar(14),
	Gender varchar(20),
	RollNumber varchar(100),
	DateOfBirth DateTime,
	StudentBloodGroup varchar(10),
	...
	FatherBloodGroup varchar(10),
	MotherBloodGroup varchar(10),
	...
	GuardianPhoto varchar(500),
	GuardianPhone varchar(14),
	GuardianOccupation varchar(100),
	GuardianAddress varchar(1000),
...
create table StudentAttendance(
	StudentAttendance bigint primary key not null identity(1,1),
	StudentId bigint references Student(StudentId),
...
create table TeacherAttendance(
	TeacherAttendance bigint primary key not null identity(1,1),
	TeacherId bigint references Teacher(TeacherId),
	AttendanceDate DateTime,
	Present bit
);
